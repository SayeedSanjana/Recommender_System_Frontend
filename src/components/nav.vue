...
<template>
    ...
    <div class="flex font-mono">
        ...
        <div class="px-1.5">
            <div class="text-sm"><span class="font-semibold text-gray-600">Welcome, </span><span class=" font-bold text-base text-gray-700">{{userID}}</span></div>
            <div class="text-xs font-medium text-gray-700">{{this.todaysDate}}</div>
        </div>
